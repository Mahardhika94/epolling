		 ...
		 <div class="col-md-3"></div>
          <div class="col-md-6">
            <div class="card center">
			  ...
			  <form action="<?php echo site_url('Insert/add_mhs'); ?>" method="post" role="form">

                  <div class="form-group">
				  <div class="input-group col-xs-5">
                    <label class="control-label">Nim</label>
                    <input class="form-control" type="number" data-bind="value:replyNumber"  placeholder="Masukkan nim" name="nim" id="nim"
			  ...
			  <a href="javascript:history.back()" class="btn btn-default"><span class="fa fa-times"></span> Kembali</a>
                </form></div>
            </div>
          </div>
      </div>
...
<script src="<?php echo base_url(); ?>asset/js/jquery-2.1.4.min.js"></script>
    ...
    $(document).ready(function() {
      $('#nim').keyup(function(event) {
        var nim = $('#nim').val();
         var id=nim.substr(2,2);
         if(id == '25'){
           var prod="Ilmu Komunikasi";
         }else if (id == '34') {
           var prod="Sastra Inggris";
         }else if (id =='32') {
            var prod="Akuntansi";
         }else if (id =='32') {
             var prod="Hubungan Internasional";
         }else if(id=""){
           var prod="";
         }
        $('#prodi').html('<option>'+prod+'</option>');
      });
    /*  $('#prodi').focus(function(event) {
        alert('ss')
      });*/
