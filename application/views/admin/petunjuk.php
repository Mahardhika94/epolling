      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
			...
			<li class="active"><a href="petunjuk"><i class="fa fa-compass"></i><span> Petunjuk</span></a></li>
		...
		<div class="col-md-2"></div>
          <div class="col-md-8">
            <div class="card ">
              ...
              <h4			  class="text-center">Masukan  Petunjuk Pemakaian Program</h4><p>
			  <form action="<?php echo site_url('Update/up_petunjuk/'); ?>" method="post">
			  <div class="form-group">
			  <div class="input-group col-xs-12">
			  <label class="label-control">Petunjuk</label>
			  <textarea  class="form-control " name="nav" rows="15" col="130" ><?php echo $nav; ?></textarea>
			  </div>
			  </div>
			  
			  <button type="submit" class="btn btn-primary <?php if($stat =='user admin'){echo 'disabled="true"';} ?>"><span class="fa fa-check"></span> Simpan Navigasi</button>
