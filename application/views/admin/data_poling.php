    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-Home"></i> Pertanyaan Polling</h1>
				 ...
				 <?php  foreach($data as $row){
				  ...
				  ?>
                    ...
                    <tr>
                      ...
                      <td class="text-center"><a class="btn btn-danger" href="<?php echo site_url('Admin/del_quest/'. $row->id_quest .'' );?>"><span class="fa fa-remove"></span> Hapus</a>
					  <a class="btn btn-info" href="<?php echo site_url('Admin/det_quest/'. $row->id_quest .'' );?>"><span class="fa fa-edit"></span> Perbarui</a>
