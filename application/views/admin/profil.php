    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-Home"></i>Profil Admin</h1>
		...
		<div class="col-md-4"></div>
          <div class="col-md-4">
			...
			<h1 class="text-center"><span class="fa fa-user"></span> Profil Admin</h1>
             <form action="<?php echo site_url('Update/up_pro/'. $username); ?>" method="post">
			 ...
			 <div class="form-group">
			  ...
			  <input type="text"  class="form-control " name="stat" value="<?php echo $stat; ?>"readonly >
			  </div>
			  </div>
			  </div>
			  <div class="form-group">
			  ...
			  <input type="password"  class="form-control " name="password" value="<?php echo $pwd; ?>"   required>
			  </div>
			  </div>
