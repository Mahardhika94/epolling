      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li class="active"><a href="index"><i class="fa fa-home"></i><span>Beranda</span></a></li>
		...
		<div class="col-md-1"></div>
          <div class="col-md-10">
            <div class="card ">
              ...
              <h1			  class="text-center"> <div class="enjoy-css2">Selamat Datang di Panel Admin Aplikasi E-Polling Kepuasan Mahasiswa Terhadap Akademik FISE UNRIYO</div></h1><p>
			  
			  <center>
			  <p><img src="http://fise.respati.ac.id/image/profil.jpg" class="img-rounded" height="350" width="350"></p>
			  <a  href="" target="_blank" class="btn btn-primary"><span class="fa fa-file"></span> Dokumentasi </a>
