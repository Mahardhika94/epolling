    ...
    <div class="wrapper">
            ...
            <ul class="top-nav">
              ...
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-th fa-lg"></i></a>
                <ul class="dropdown-menu settings-menu">
                  <li><a href="tentang"><i class="fa fa-clone fa-lg"></i> Tenatang</a></li>
      ...
      <div class="content-wrapper">
		...
		<div class="col-md-1"></div>
          <div class="col-md-10">
            <div class="card ">
			 <h3 align="center"> <img class="img img-rounded center" src="https://www.brandignity.com/wp-content/uploads/2015/07/thank-you.jpg" height="120"></h3>
			 
			<p align="text-center">Anda Telah Melakukan Polling terhadap kualitas pelayanan Fakultas Ilmu Sosial dan Ekonomi</p>
             <a class="btn btn-warning btn-block" href="main_user">Menu Utama </a>
            </div>
          </div>
		  <div class="col-md-1"></div>
        </div>
