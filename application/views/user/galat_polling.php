    ...
    <section class="login-content">
     ...
     <div class="row">
          ...
          <div class="form-group">
            ...
            <h4 align="justify">Proses Polling belum dapat dilakukan karena belum masuk waktu penyelengaraan, waktu penyelengaran sudah lewat atau  Admin belum mengaktifkan proses polling</h4>
          </div>
          
          <div class="form-group btn-container">
           </p>
			<a onclick="window.history.back()" class="btn btn-default btn-block"><i class="fa fa-sign-in fa-lg fa-fw"></i>kembali</a>
          </div></div>
            </div>
          </div>
    </section>
