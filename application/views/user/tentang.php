...
.quest1 {
  ...
  <body class="sidebar-mini fixed" onload="klik()">
    <div class="wrapper">
            ...
            <ul class="top-nav">
              ...
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-th fa-lg"></i></a>
                <ul class="dropdown-menu settings-menu">
                  <li><a href="<?php echo site_url('User/tentang'); ?>"><i class="fa fa-clone fa-lg"></i> About</a></li>
				  <li <?php if($stat ==''){echo 'hidden';} ?>><a href="<?php echo site_url('User/nav'); ?>"><i class="fa fa-compass"></i> Petunjuk</a></li>
      ...
      <div class="content-wrapper">
		...
		<div class="col-md-1"></div>
          <div class="col-md-10">
            <div class="card">
              <h3 class="card-title text-center">Tentang</h3>
              <div class="card-body"><?php echo $tentang; ?>   </div>
            </div>
          </div>
	   ...
	   <div class="col-md-2"></div>
          <div class="col-md-8">
            <div class="widget-small primary"><i onclick="call(9)" class="icon fa fa-phone fa-3x"></i>
              <div class="info">
                <h4></h4>
                <p><b><?php echo $nope;?></b></p>
				<input type="text" name="nope" id="nope" value="<?php echo $nope; ?>" hidden> 
              </div>
            </div>
          </div>
		  <div class="col-md-2"></div>
	...
	<div class="row">
	    <div class="col-md-2"></div>
          <div class="col-md-8">
            <div class="widget-small primary"><a href="mailto:<?php echo $email;?>"><i class="icon fa fa-envelope fa-3x"></a></i>
              <div class="info">
                <h4></h4>
